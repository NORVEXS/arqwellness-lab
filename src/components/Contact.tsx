              ...
              <form onSubmit={onSubmit} className="mt-7 grid gap-4 sm:grid-cols-2">
                ...
                <label className="text-left sm:col-span-1">
                  ...
                  <input
                    ...
                    className="mt-2 block w-full appearance-none rounded-xl border border-line bg-white px-4 py-3 text-sm text-ink placeholder:text-ink-subtle focus:border-brand-blue focus:outline-none focus:ring-2 focus:ring-brand-blue/30 dark:border-white/15 dark:bg-white/[0.04] dark:text-white dark:placeholder:text-white/40 dark:focus:border-brand-blue-soft dark:focus:ring-brand-blue-soft/30"
                  />
                </label>
                <label className="text-left sm:col-span-1">
